...
public class GongsiController {
  ...
  public Map<String, Object> getGongsiList(
      ...
      @Parameter(description = "정렬 기준 (latest, views, oldest)", example = "latest")
          ...
          String sort,
      @Parameter(description = "내용 포함 여부", example = "false") @RequestParam(defaultValue = "false")
          Boolean content,
      @Parameter(description = "페이지 번호 (1~100)", example = "1") @RequestParam(defaultValue = "1")
          Integer page,
      @Parameter(description = "페이지 크기 (10~100)", example = "8") @RequestParam(defaultValue = "8")
          Integer size,
            ...
            "gongsiList",
                List.of(
                    ...
                    Map.of(
                        ...
                        "느아아악 나는 배고프다")),
            "gongsiListSize", 2,
            "pagination", Map.of("currentPage", 1, "totalPages", 3, "totalResults", 25)));
  }
  ...
  public Map<String, Object> getGongsiDetail(
    ...
    return Map.of(
        ...
        Map.of(
            ...
            "company", Map.of("id", 1, "name", "삼성전자", "prdyCtr", 2.43, "isSubscribed", false)));
  }
}
